...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Shivraj\Desktop\Python model\locationFinder'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Shivraj\Desktop\Python model\locationFinder\Scripts\deactivate.nu'
